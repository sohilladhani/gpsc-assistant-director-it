const QUESTIONS = [
    ...
    },
    {
        ...
        options: {
            ...
            B: "20 to 22",
            C: "0 to 2",
            D: "31 to 33PROVISIONAL ANSWER KEY NAME OF THE POST : Asst. Director IT Directorate of ICT and E-Governerce, Class-I,(AUV)(Advt. No. : 67/2016-17) Date of Preliminary Test : 29/01/2017 Subject : Concerned Subject (Que. 101 to 3 00) AUV-A ] [ 18 ] [ Contd..."
        }
    },
    {
        id: 103,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Spread spectrum signals are hard to jam and identify AUV-A ] [ 20 ] [ Contd..."
        }
    },
    {
        id: 114,
    ...
    },
    {
        ...
        options: {
            ...
            C: "Network receivers",
            D: "Altering permissions AUV-A ] [ 21 ] [ P .T.O."
        }
    },
    {
        id: 121,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Android Package AUV-A ] [ 22 ] [ Contd..."
        }
    },
    {
        id: 130,
...
Which of the above is (are) the valid locking sequence(s) for tree-based protocol?`,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Thomas’ s write rule provides greater concurrency than time stamp order protocol AUV-A ] [ 25 ] [ P .T.O."
        }
    },
    {
        id: 148,
...
| S. Non recoverable | 4. Tj reads data items written by Ti, the commit operation of Ti appears before the read operation of Tj |`,
    ...
    },
    {
        ...
        options: {
            ...
            B: "126",
            C: "5!*4!",
            D: "None of the above AUV-A ] [ 26 ] [ Contd..."
        }
    },
    {
        id: 153,
...
\`\`\``,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Graph G has multiple spanning trees of different costs AUV-A ] [ 28 ] [ Contd..."
        }
    },
    {
        id: 165,
    ...
    },
    {
        ...
        options: {
            ...
            B: "4 blocks",
            C: "5 blocks",
            D: "More then 5 blocks AUV-A ] [ 29 ] [ P.T.O."
        }
    },
    {
        id: 170,
    ...
    },
    {
        ...
        options: {
            ...
            D: "two prime attributes AUV-A ] [ 30 ] [ Contd..."
        }
    },
    {
        id: 177,
    ...
    },
    {
        ...
        options: {
            A: "π sid (σcolor=red or color=green (parts)אpid catalog)",
            B: "π sid (σcolor=red or color=red (parts)אpid catalog)",
            C: "π pid (σcolor=red or color=green (parts)אpid catalog)",
            D: "π pid (σcolor=red or color=green (parts)אsid catalog)"
        }
    },
    {
        id: 184,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Both I and II are false AUV-A ] [ 33 ] [ P.T.O."
        }
    },
    {
        id: 195,
    ...
    },
    {
        ...
        options: {
            ...
            D: "All of the above AUV-A ] [ 35 ] [ P.T.O."
        }
    },
    {
        id: 211,
    ...
    },
    {
        ...
        options: {
            ...
            B: "PaaS",
            C: "IaaS",
            D: "All of the above AUV-A ] [ 36 ] [ Contd..."
        }
    },
    {
        id: 220,
    ...
    },
    {
        ...
        options: {
            ...
            D: "All of the above AUV-A ] [ 38 ] [ Contd..."
        }
    },
    {
        id: 238,
    ...
    {
        id: 240,
        text: `A real world system is called relative to the true model structure at ΘRS if: (I) Parameter identifiable if there exists an input sequence { UK} such that Θ and ΘRS are distinguishable for all Θ ≠ ΘRS (II) System identifiable if there exist an input sequence { UK} such that Θ and ΘRS are distinguishable for all Θ ≠ ΘRS but a finite set (III) Unidentifiable in all other cases`,
        options: {
    ...
    },
    {
        ...
        options: {
            ...
            D: "None of the above AUV-A ] [ 39 ] [ P.T.O."
        }
    },
    {
        id: 244,
    ...
    },
    {
        ...
        options: {
            ...
            D: "12 address lines and 8 data lines. AUV-A ] [ 40 ] [ Contd..."
        }
    },
    {
        id: 250,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Online job searching. AUV-A ] [ 41 ] [ P.T.O."
        }
    },
    {
        id: 256,
    ...
    },
    {
        ...
        options: {
            ...
            D: "Social Media, Material, Atomicity, Cloud AUV-A ] [ 46 ] [ Contd..."
        }
    },
    {
        id: 288,
    ...
    },
    {
        ...
        options: {
            ...
            B: "I is false and II is true",
            C: "Both I and II are true",
            D: "Both I and II are false AUV-A ] [ 47 ]"
        }
    },
    {
        id: 296,
